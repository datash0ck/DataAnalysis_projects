...
# CO2 Emissions Analysis with Predictive Modeling using Linear Regression

# Purpose: Shows how energy use and economic wealth (GDP) drive CO2 emissions,
# and to identify realtionship and impacts between the variables.
# Relevant to the Oil, Gas, and Environmental sectors
...
#Linear regression model used to identify relationship between variables
#Goal is to identify impacts of Energy Per Capita and GDP Per Capita on CO2 Per Capita
model <- lm(CO2_Per_Capita ~ Energy_Per_Capita + GDP_Per_Capita, data= merged_data)
summary(model)

------------------------------------------------------------------

#Added predictions to dataset
